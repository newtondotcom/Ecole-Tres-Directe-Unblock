const injectEDPStyles = () => {
	...
	).textContent = "Ecole Tres Directe";
	document.querySelector("#A2").src =
		"https://ecole-tres-directe.vercel.app/images/EDP-logo-black.svg";
	document.querySelector("h3.panel-title").textContent =
		...
		document
			...
			.toLowerCase();
	document.querySelector('a').href = 'https://ecole-tres-directe.vercel.app/#home';
...
if (new URL(document.referrer).hostname.includes("ecole-tres-directe.vercel.app")) {
	injectEDPStyles();
}