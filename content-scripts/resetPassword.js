const injectEDPStyles = () => {
	...
	document.querySelector("#A2").src =
		"https://ecole-tres-directe.eu/images/EDP-logo-black.svg";
	document.querySelector("h3.panel-title").textContent =
		...
		document
			...
			.toLowerCase();
	document.querySelector('a').href = 'https://ecole-tres-directe.eu/#home';
...
if (new URL(document.referrer).hostname.includes("ecole-tres-directe.eu")) {
	injectEDPStyles();
}