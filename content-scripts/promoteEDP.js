	...
	if (path === "/login") {
		let adLoginHTML = `
            <div style="font-size: 20px; font-weight: 300; color: #fff;">
                Vous cherchez EcoleDirecte, mais en mieux ? Jetez un coup d'oeil à Ecole Tres Directe !
                <br>
                <br>
	...
	let adHomeHTML = `
        <div class="item-postit col-lg-4 ng-star-inserted" id="EDPAd">
            ...
            <div class="note-postit gestion-postit" style="background-color: #d2d2ff;">
                ...
                <span style="display: block; margin-top: 5px; text-align: center; color: #15141A; z-index: 1; user-select: none; font-weight: bold; width: 100%;">Ecole Tres Directe n'est affilié ni à EcoleDirecte ni à la société Aplim.</span>
                <div class="clearfix"></div>
